...
export async function upgradeScreenshotToolResult(
	...
	const hint: TextContent = {
		type: "text",
		text: "[pi-images: screenshot was saved via filePath but the image file was not readable from Pi. If you need to inspect the screenshot agentically, retry the screenshot tool without filePath so the image is returned inline.]",
	};
	return {
